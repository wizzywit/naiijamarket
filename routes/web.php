...
Route::group(['as'=>'naijamarket.'], function () {
    Route::get('/home', 'HomeController@index2')->name('home');
    Route::get('/product/{id}', 'ProductController@showSingleProduct')->name('product.show');
    Route::get('/shop/product/{id}','ShopController@shopProduct')->name('shop.product');
